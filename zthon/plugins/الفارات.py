...
ZelzalVP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𝗣𝗼𝘄𝗲𝗿𝘁𝗵𝗼𝗻 𝗖𝗼𝗻𝗳𝗶𝗴 𝗩𝗮𝗿𝘀 - اوامـر الفـارات](t.me/Power_Thon) 𓆪\n\n"
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        if variable in heroku_var:
            await zed.edit("**❈╎تم تغييـر {} بنجـاح ☑️**\n**❈╎المتغيـر : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت باورثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, vinfo))
        else:
            await zed.edit("**❈╎تم اضافـة {} بنجـاح ☑️** \n**❈╎المضاف اليه :**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت باورثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, vinfo))
...
async def variable(event):
    ...
    if input_str == "كليشة الفحص" or input_str == "كليشه الفحص":
        ...
        await zed.edit("**❈╎تم حـذف {} بنجـاح ☑️**\n**❈╎المتغيـر المحـذوف : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت باورثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, variable))
        ...
        if variable not in heroku_var:
        	return await zed.edit("**❈╎عـذࢪاً عـزيـزي .. انت لـم تقـم بإضـافـة فـار {} اصـلاً...**".format(input_str))
        await zed.edit("**❈╎تم حـذف {} بنجـاح ☑️**\n**❈╎المتغيـر المحـذوف : ↶**\n `{}` \n**❈╎يتم الآن إعـادة تشغيـل بـوت باورثـون يستغـرق الامر 2-1 دقيـقة ▬▭ ...**".format(input_str, heroku_var[variable]))

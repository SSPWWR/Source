...
LOGS = logging.getLogger("سورس باورثـون")
...
try:
    LOGS.info("✧ بـدء تنزيـل باورثـون ✧")
    zedub.loop.(setup_bot())
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["pwerthon","Power_Thon","group_powerr","uuuo_u","VipDDe","tttfftttt"]
    ...
    print(f"⌔┊تـم تنصيـب باورثــون . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()

...
LOGS = logging.getLogger("سورس باورثــــون")
...
try:
    LOGS.info("✧ بـدء تنزيـل باورثــــون ✧")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Tepthon","P17_12","Tepthone1","Tws_Tepthon","Tepthon_Help","super_tepthon","tepthonklaesh","x_wwl","K_K_Q_L","VisaTepthon","zszxzz","TIKTOK_ased","huueuu","PyThOnX1"]
    ...
    print(f"⌔┊تـم تنصيـب باورثــــون . . بنجـاح ✓ \n⌔┊لـ إظهـار الاوامـر ارسـل (.الاوامر)")
    await verifyLoggerGroup()
